...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::thought_cmds::append_to_thought,
            commands::thought_cmds::list_thought_children,
            commands::thought_cmds::list_thought_descendants,
            commands::thought_cmds::find_root_thought,
